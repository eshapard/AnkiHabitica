...
def seconds_count(start_date):
    ...
    if ah.settings.keep_log: ah.log.debug("End function returning: %s" %  dbTime)
    return dbTime
...
def timebox_count(start_date):
    ...
    if ah.settings.keep_log: ah.log.debug("End function returning: %s" %  dbTboxes)
    return dbTboxes
...
def matured_count(start_date):
    ...
    if ah.settings.keep_log: ah.log.debug("End function returning: %s" %  dbMatured)
    return dbMatured
...
def learned_count(start_date):
    ...
    if ah.settings.keep_log: ah.log.debug("End function returning: %s" %  learned)
    return learned
...
def decks_count(start_date):
    ...
    if ah.settings.keep_log: ah.log.debug("End function returning: %s" %  dbDecks)
    return dbDecks
...
def latest_review_time():
    ...
    if ah.settings.keep_log: ah.log.debug("End function returning: %s (%s)" %  (out, prettyTime(out)))
    return out
